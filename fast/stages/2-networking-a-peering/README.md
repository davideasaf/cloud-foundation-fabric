...
| [monitoring.tf](./monitoring.tf) | Network monitoring dashboards and alerts. |  | <code>google_monitoring_alert_policy</code> · <code>google_monitoring_dashboard</code> |
